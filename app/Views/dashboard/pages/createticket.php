...
<div class="container mx-auto col-span-6 py-8 px-4">
    <div class="grid text-center">
        <span class="text-gray-300 z-0 bg-gradient-to-b from-gray-900 to-gray-800 border-t-4 border-gray-800 rounded-lg py-4 text-2xl">Novo ticket</span>
    </div>
    <div class="bg-black rounded-b-lg">
        <div class="px-72 py-12 place-items-center">
            <form method="POST" action="<?= base_url('auth/createticket') ?>" class="mt-6">
                ...
                <a href="<?= base_url('dashboard/tickets') ?>" class="block text-center w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-gray-900 rounded border-b-4 border-gray-800 shadow-lg focus:outline-none hover:bg-gray-800 hover:border-gray-700 hover:shadow-none">
                    Voltar
                </a>
            </form>
        </div>
