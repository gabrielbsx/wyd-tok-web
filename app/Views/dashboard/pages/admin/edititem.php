        ...
        <form action="<?= base_url('auth/edititem') ?>" method="POST">
            ...
            <div class="bg-black rounded-b-lg">
                <div class="px-24 py-12 text-white place-items-center">
                    ...
                    <input id="itemcode" type="text" name="itemcode" value="<?= $bonus['itemcode'] ?>" class="mb-4 block rounded w-full p-3 mt-2 text-gray-200 bg-gray-800 appearance-none focus:outline-none focus:bg-gray-900 focus:shadow-inner" required />
