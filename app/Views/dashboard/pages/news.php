...
<div class="container mx-auto col-span-6 py-8 px-4">
    ...
    <div class="bg-black py-6 px-12 rounded-b-lg">
        <div class="grid text-center mb-6">
            <a href="<?= base_url('dashboard/createnews') ?>" class="py-4 px-6 w-full text-gray-300 bg-gray-800 hover:bg-gray-700 rounded">Adicionar nova notícia</a>
        </div>
                    ...
                    <div class="col-span-4 grid grid-cols-8 my-2 px-1 py-4 px-6 bg-gray-800 border-b-4 border-gray-900 text-gray-300 rounded-lg bg-black">
                        ...
                        <div class="col-span-2 text-right">
                            <div class="grid grid-cols-2 text-center">
                                <a href="<?= base_url('dashboard/editnews/' . $value['id']) ?>" class="bg-blue-700 hover:bg-blue-600 hover:border-blue-800 col-span-1 px-12 mr-2 py-2 rounded-lg border-b-4 border-blue-900">
                                    Editar
                                </a>
